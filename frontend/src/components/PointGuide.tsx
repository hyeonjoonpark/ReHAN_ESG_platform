  ...
  return (
    <div className="relative flex flex-col items-center justify-center h-full">
      ...
      <div className="absolute top-0 right-0">
        <button 
          onClick={onBack}
          className="bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 px-6 py-3 rounded-full text-gray-800 dark:text-white font-semibold transition-all duration-300"
        >
          이전으로
        </button>
      </div>
      ...
      <div className="text-center w-full max-w-4xl px-4">
        ...
        {/* 포인트 적립 안내 박스 */}
        <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 mx-auto max-w-3xl text-left">
